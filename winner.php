...
// $roundNumber = 1;
$winners = $dataObj->getWinnerPlayer($roundNumber - 1);
?>
<!DOCTYPE html>
<html>
...
<body>
    ...
    <form action="insert.php" method="POST">
        ...
        <input type="submit" name="winner_create_match" value="Create Match">
    </form>
    ...
    <ul>
        ...
        <?php $checkLastRoundDetails = 0;
        foreach ($winners as $winner):
            $checkLastRoundDetails++; ?>
            <li>
                <?= $winner['name']; ?>
            </li>
        <?php endforeach;
    ...
    if ($checkLastRoundDetails == 1) {

        ?>
        <a href="finnal.php?round=<?= $nextRoundNumber; ?>" target="_blank">Finnal Round

...
// $roundNumber = 1;
$winnerBrackets = $dataObj->getLastPlayer(1);
$loserBrackets = $dataObj->getLastPlayer(0);
...
<body>
    ...
    <form action="insert.php" method="POST">
        ...
        <input type="submit" name="final_create_match" value="Create Match">
    </form>
    ...
    <ul>
        <?php foreach ($winnerBrackets as $winner): ?>
            <li>
                <?= $winner['name']; ?>
            </li>
        <?php endforeach; ?>
    ...
    <ul>
        <?php foreach ($loserBrackets as $loser): ?>
            <li>
                <?= $loser['name']; ?>
            </li>
        <?php endforeach; ?>
